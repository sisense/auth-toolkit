...
namespace sisense_wat_generator
{
    class Configuration
    {
        ...
        public static readonly Dictionary <string, object> TokenHeader = new Dictionary<string, object>()
        {
...
-----END PUBLIC KEY-----";
        ...
        // https://sisense.dev/reference/jaql/
         private const string SampleFltString = @"{
                    jaql: {
                        ""table"": ""Commerce"",
                        ""column"": ""Condition"",
        ...
        public static readonly Object TokenPayload = new
        {
            ...
            grants = new
            {
                ...
                res = new[] {"dashboards/60ec626ffd920200358e7766"},
                // Dashboard / Widget filters
                flt = new[] {JObject.Parse(SampleFltString)},
